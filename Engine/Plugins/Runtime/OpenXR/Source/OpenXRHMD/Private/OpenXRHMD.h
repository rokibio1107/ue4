...
protected:
	...
	void DrawEmulatedQuadLayers_RenderThread(FRHICommandListImmediate& RHICmdList, const FSceneView& InView);
...
public:
	...
	virtual void PostRenderView_RenderThread(FRHICommandListImmediate& RHICmdList, FSceneView& InView) override; // for non-face locked compositing
